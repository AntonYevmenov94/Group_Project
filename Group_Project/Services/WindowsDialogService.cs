...
namespace Group_Project.Services
{
    class WindowsDialogService : IDialogService
    {
        ...
        public void Show(BaseViewModel dialogVm, Action onConfirm, Action onDismiss)
        {
            throw new NotImplementedException();
        }

        public void ShowModal(BaseViewModel dialogVm, Action onConfirm, Action onDismiss)
        {
            throw new NotImplementedException();
        }

        public void SaveFileDialog(Action onConfirm = null, Action onDismiss = null)
        {
            throw new NotImplementedException();
        }

        public void OpenFileDialog(Action onConfirm = null, Action onDismiss = null)
        {
            throw new NotImplementedException();
        }
    }
