...
namespace Group_Project
{
    public class JobSeekerDbContext : DbContext
    {
        ...
        private static void SeedDbTables(JobSeekerDbContext context)
        {
            ...
            {
                new Person(){Name="Name1", Surname="Surname1", Patronymic="Patronymic1", DateOfBirth=DateTime.Now.AddYears(-18), SexId=1, StatusId=1, Experience="Experience1", Education="Education1", Stars=1},
                new Person(){Name="Name2", Surname="Surname2", Patronymic="Patronymic2", DateOfBirth=DateTime.Now.AddYears(-22), SexId=1, StatusId=2,
                ...
                new Person(){Name="Name3", Surname="Surname3", Patronymic="Patronymic3", DateOfBirth=DateTime.Now.AddYears(-16), SexId=2, StatusId=3, Experience="Experience3", Education="Education3", Stars=3},
                new Person(){Name="Name4", Surname="Surname4", Patronymic="Patronymic4", DateOfBirth=DateTime.Now.AddYears(-31), SexId=2, StatusId=4, Experience="Experience4", Education="Education4", Stars=4},
                new Person(){Name="Name5", Surname="Surname5", Patronymic="Patronymic5", DateOfBirth=DateTime.Now.AddYears(-41), SexId=3, StatusId=5, Experience="Experience5", Education="Education5", Stars=5},
                new Person(){Name="Name6", Surname="Surname6", Patronymic="Patronymic6", DateOfBirth=DateTime.Now.AddYears(-55), SexId=3, StatusId=5, Experience="Experience6", Education="Education6", Stars=5},
                new Person(){Name="Name7", Surname="Surname7", Patronymic="Patronymic7", DateOfBirth=DateTime.Now.AddYears(-19), SexId=3, StatusId=5, Experience="Experience7", Education="Education7", Stars=5},
                new Person(){Name="Name8", Surname="Surname8", Patronymic="Patronymic8", DateOfBirth=DateTime.Now.AddYears(-16), SexId=3, StatusId=5, Experience="Experience8", Education="Education8", Stars=5},
                new Person(){Name="Name9", Surname="Surname9", Patronymic="Patronymic9", DateOfBirth=DateTime.Now.AddYears(-74), SexId=3, StatusId=5, Experience="Experience9", Education="Education9", Stars=5},
                new Person(){Name="Name10", Surname="Surname10", Patronymic="Patronymic10", DateOfBirth=DateTime.Now.AddYears(-53), SexId=3, StatusId=5, Experience="Experience10", Education="Education10", Stars=5},
                new Person(){Name="Name11", Surname="Surname11", Patronymic="Patronymic11", DateOfBirth=DateTime.Now.AddYears(-44), SexId=3, StatusId=5, Experience="Experience11", Education="Education11", Stars=5},
                new Person(){Name="Name12", Surname="Surname12", Patronymic="Patronymic12", DateOfBirth=DateTime.Now.AddYears(-33), SexId=3, StatusId=5, Experience="Experience12", Education="Education12", Stars=5},
                new Person(){Name="Name13", Surname="Surname13", Patronymic="Patronymic13", DateOfBirth=DateTime.Now.AddYears(-39), SexId=3, StatusId=5, Experience="Experience13", Education="Education13", Stars=5},
                new Person(){Name="Name14", Surname="Surname14", Patronymic="Patronymic14", DateOfBirth=DateTime.Now.AddYears(-26), SexId=3, StatusId=5, Experience="Experience14", Education="Education14", Stars=5},
                new Person(){Name="Name15", Surname="Surname15", Patronymic="Patronymic15", DateOfBirth=DateTime.Now.AddYears(-42), SexId=3, StatusId=5, Experience="Experience15", Education="Education15", Stars=5}
            };
